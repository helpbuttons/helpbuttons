...
export class ImagesComments1722853754108 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "post" ADD "images" text array NOT NULL DEFAULT '{}'`);
        await queryRunner.query(`ALTER TABLE "comment" ADD "images" text array NOT NULL DEFAULT '{}'`);
    }
