...
export class init1671070089549 implements MigrationInterface {
    name = 'init1671070089549'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "network" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id" character varying NOT NULL, "name" character varying, "description" character varying NOT NULL, "radius" double precision NOT NULL, "latitude" double precision NOT NULL, "longitude" double precision NOT NULL, "location" geometry NOT NULL, "tags" text array DEFAULT '{}', "logo" text, "jumbo" text, CONSTRAINT "PK_8f8264c2d37cbbd8282ee9a3c97" PRIMARY KEY ("id"))`);
