...
export class init1658147243566 implements MigrationInterface {
    name = 'init1658147243566'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "network" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id" character varying NOT NULL, "name" character varying, "description" character varying NOT NULL, "url" character varying, "radius" double precision NOT NULL, "latitude" double precision NOT NULL, "longitude" double precision NOT NULL, "location" geography NOT NULL, "tags" text array DEFAULT '{}', "avatar" text, CONSTRAINT "PK_8f8264c2d37cbbd8282ee9a3c97" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."button_type_enum" AS ENUM('offer', 'need', 'exchange')`);
        await queryRunner.query(`CREATE TABLE "button" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id" character varying NOT NULL, "description" character varying NOT NULL, "latitude" double precision NOT NULL, "longitude" double precision NOT NULL, "location" geography NOT NULL, "type" "public"."button_type_enum" NOT NULL DEFAULT 'need', "tags" text array DEFAULT '{}', "images" text array, "networkId" character varying, "ownerId" character(36), CONSTRAINT "PK_a4df4e4f7a5882bc94442d3f209" PRIMARY KEY ("id"))`);
