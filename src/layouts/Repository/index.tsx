  ...
  return (
    <div className="repository">
      <div className="repository__content">
        ...
        <h2 className="repository__h2">List of elements</h2>

        <h3 className="repository__title">Elements/btn :</h3>
        ...
        <section className="repository__section">
          ...
          <button className="btn-with-icon btn-with-icon--need">
            ...
            <div className="btn-with-icon__text">Necesito</div>
          </button>
          ...
          <button className="btn-with-icon button-with-icon--offer">
            ...
            <div className="btn-with-icon__text">Ofrezco</div>
          </button>

          <Btn
            iconLeft={IconType.green}
            caption="Ofrezco inactivo Btn"
            disabled={true}
          />
          <button disabled className="btn-with-icon button-with-icon--offer">
            <div className="btn-filter__icon green"></div>
            <div className="btn-with-icon__text">Ofrezco inactivo</div>
          </button>
          ...
          <button className="btn-with-icon">
            ...
            <div className="btn-with-icon__text">Intercambio</div>
          </button>
          ...
          <Btn
            ...
            caption="Botón ejemplo negro centrado Btn"
          />
          ...
          <button className="btn-filter">Filter example</button>
          ...
          <Btn
            ...
            disabled={true}
            caption="Filter disabled example Btn"
          />
          ...
          <Btn
            btnType={BtnType.filter}
            iconLeft={IconType.splitRedGreen}
            caption="Filter with icon split Btn"
          />
          ...
          <Btn
            btnType={BtnType.filter}
            iconLeft={IconType.green}
            caption="Filter with icon green Btn"
          />
          <button className="btn-filter-with-icon">
            <div className="btn-filter__icon green"></div>
          ...
          <Btn
            ...
            caption="Filter with double icon Btn"
          />
          <button className="btn-filter-with-icon">
            <div className="btn-filter__icon green"></div>
          ...
          <div className="checkbox-filter__container">
            <label className="checkbox__filter-label">
              ...
              <div className="checkbox-filter__content btn-filter-with-icon">
                ...
                <div className="checkbox__text">Filter checkbox</div>
              </div>
            </label>
          </div>
        ...
        <h3 className="repository__title">elements/form</h3>
        <hr></hr>
        ...
        <section className="repository__section">
          ...
          <div className="form__field">
            <label className="form__label label">Text label</label>
            <input
              type="text"
              className="form__input"
              placeholder="Placeholder"
          ...
          <div className="form__options-h">
            <div className="btn form__options-btn">CANCEL</div>
            <div className="btn form__options-btn">SAVE</div>
          </div>

          <hr></hr>

          <div className="form__options-h">
            <div className="form__options-text">Explain something</div>
            <div className="btn form__options-btn">CANCEL</div>
          </div>
        ...
        <h3 className="repository__title">elements/textarea</h3>
        ...
        <h3 className="repository__title">elements/dropdown</h3>
        <section className="repository__section">
          <div className="dropdown-select">
            <div className="label">label dropdown</div>
            <select className="dropdown-select__trigger">
              <option value="status" className="dropdown-select__option">
                Status changes
              </option>
              <option value="status" className="dropdown-select__option">
                All comments
              ...
              <option value="status" className="dropdown-select__option">
                Other buttons interactions
              </option>
              <option value="status" className="dropdown-select__option">
                My buttons interactions
              </option>
            </select>
          </div>
          ...
          <datalist className="dropdown-nets__dropdown-content" id="listid">
            ...
            <option
              className="dropdown-nets__create-new-button"
              label="label2"
              value="Net2"
            >
              Create Net
        ...
        <h3 className="repository__title">elements/checkbox</h3>
        <section className="repository__section">
          <div className="label">label checkbox</div>
          <CheckBox
            icon="cross"
            text="Ahora CheckBox"
            inputId="ahora-checkbox"
          />
          <div className="checkbox">
            <label className="checkbox__label">
              ...
              <div className="checkbox__content">
                ...
                <div className="checkbox__text">Ahora</div>
              </div>
            </label>
          </div>
          ...
          <CheckBox
            icon="red"
            text="Necesito Ahora CheckBox"
            inputId="necesito-ahora-checkbox"
          />
          <div className="checkbox">
            <label className="checkbox__label">
              <input
              ...
              <div className="checkbox__content">
                ...
                <div className="checkbox__text">Necesito Ahora</div>
              </div>
            </label>
          </div>
          ...
          <CheckBox
            icon="cross"
            text="Fecha/hora concreta CheckBox"
            inputId="fecha-hora-concreta-checkbox"
          />
          <div className="checkbox">
            <label className="checkbox__label">
              <input
              ...
              <div className="checkbox__content">
                ...
                <div className="checkbox__text">Fecha/hora concreta</div>
              </div>
            </label>
          </div>
          ...
          <CheckBox
            icon="cross"
            text="Cerca de mí CheckBox"
            inputId="cerca-de-mi-checkbox"
          />
          <div className="checkbox">
            <label className="checkbox__label">
              <input
              ...
              <div className="checkbox__content">
                ...
                <div className="checkbox__text">Cerca de mi</div>
              </div>
            </label>
          </div>
        </section>

        <h3 className="repository__title">elements/text-style</h3>
        <section className="repository__section repository__section--yellow">
          <h1 className="title__h1">Reference site about Lorem Ipsum, h1</h1>

          <hr></hr>

          <h1 className="title__h2">Reference site about Lorem Ipsum, h2</h1>

          <hr></hr>

          <h1 className="title__h3">Reference site about Lorem Ipsum, h3</h1>

          <hr></hr>

          <p className="paragraph">
            Lorem ipsum es el texto que se usa habitualmente en{" "}
            <a href="">diseño gráfico en demostraciones</a> de tipografías o de
            borradores de diseño para probar el diseño visual..
          </p>
        </section>

        <h3 className="repository__title">elements/hashtag</h3>
        <section className="repository__section">
          <a href="" className="hashtag hashtag--need">
            example
          </a>
          <a href="" className="hashtag hashtag--offer">
            example
          </a>
          <a href="" className="hashtag hashtag--yellow">
            example
          </a>
          <a href="" className="hashtag hashtag--yellow-home">
            example
          </a>
          <a href="" className="hashtag hashtag--white">
            example
          </a>
        ...
        <h3 className="repository__title">elements/avatar</h3>
        <section className="repository__section">
          <div className="avatar-medium">
            <img
              src="https://dummyimage.com/50/#ccc/fff"
              alt="Avatar"
          ...
          <div className="avatar-small">
            <img
              src="https://dummyimage.com/30/#ccc/fff"
              alt="Avatar"
              className="picture__img"
            ></img>
          </div>
        ...
        <h2 className="repository__h2">List of components</h2>

        <h3 className="repository__title">components/card-button-map</h3>
        <section className="repository__section repository__section--yellow">
          <div className="card-button-map card-button-map--need">
              ...
              <div className="card-button-map__header ">
                <div className="card-button-map__info">
                  <div className="card-button-map__status card-button-map__status">
                    <span className="card-button-map__status--offer">
                      button type
                    </span>{" "}
                    y{" "}
                    <span className="card-button-map__status--need">
                      button type
                    </span>
                  </div>
                </div>
            ...
            <div className="card-button-map__picture-container">
              ...
              <img
                src="https://dummyimage.com/500x250/#ccc/fff"
                alt="button-picture"
                className="card-button-map__picture picture__img"
              ></img>
            </div>
          </div>
        </section>
          ...
          <div className="card-button-list card-button-list--need">
            ...
            <div className="card-button-list__content">
              <div className="card-button-list__header">
                <div className="card-button-list__info">
                  <div className="card-button-list__status card-button-list__status">
                    ...
                    y{" "}
                    <span className="card-button-list__status--need">
                      button type
                    </span>
                  </div>
              ...
              <div className="card-button-list__geoDate">
                ...
                <div className="card-button-list__date">Date</div>
              </div>
            </div>
          </div>
        </section>

        <h3 className="repository__title">components/popup-header</h3>
          ...
          <div className="popup__header">
            <header className="popup__header-content">
              ...
              <div className="popup__header-center">
                <h1 className="popup__header-title">Username</h1>
              </div>
        ...
        <h3 className="repository__title">components/card-button</h3>
          ...
          <div className="card-button card-button card-button--need">
            <div className="card-button__content">
              <div className="card-button__nets">
                <img
                  src=""
                  alt=""
                  className="card-avatar card-button__net-icon"
                ></img>
              </div>
              ...
              <div className="card-button__header">
                ...
                <div className="card-button__info">
                  <div className="card-button__status card-button__status">
                    <span className="card-button__status--offer">
                      button type
                    </span>{" "}
                    y{" "}
                    <span className="card-button__status--need">
                      button type
                    </span>
                  </div>

                  <div className="card-button__name">Username</div>
                </div>
              ...
              <div className="card-buttons">
                ...
                <div className="card-button__date">Date</div>
              </div>
            </div>
            ...
            <picture className="card-button__picture picture">
              ...
              <img
                src="https://dummyimage.com/1000/#ccc/fff"
                alt="button-picture"
                className="card-button__picture picture__img"
              ></img>
            </picture>
          </div>
        ...
        <h3 className="repository__title">component/card-notification</h3>
        <section className="repository__section">
            ...
            <div className="card-notification__content">
              ...
              <div className="card-notification__text">
                <div className="card-notification__header">
                  ...
                  <div className="card-notification__date">hace 2 días</div>
                </div>
                <h2 className="card-notification__title">Jorge</h2>
                <div className="card-notification__paragraph">
                  Lorem ipsum es el texto que se usa en diseño gráfico en
                  demostraciones...
                </div>
              </div>
            </div>
          ...
          <div className="card-notification card-notification--offer">
            <div className="card-notification__content">
              ...
              <div className="card-notification__text">
                ...
                <div className="card-notification__paragraph">
                  Lorem ipsum es el texto que se usa en diseño gráfico en
                  demostraciones Lorem ipsum es el texto que se usa en diseño
        ...
        <h3 className="repository__title">component/card-feed</h3>
        ...
        <h3 className="repository__title">component/card-profile</h3>
        ...
        <section className="repository__section">
          <div className="card-profile__container">
            ...
            <div className="btn-with-icon">
              ...
              <span className="btn-with-icon__text">Cerrar sesión</span>
            </div>
          </div>
        </section>
        ...
        <h3 className="repository__title">component/popup-signup</h3>
          ...
          <div className="popup">
            <div className="popup__header">
              <header className="popup__header-content">
                ...
                <div className="popup__header-center">
                  <h1 className="popup__header-title">Signup</h1>
                </div>
                <div className="popup__header-right">
                  <button className="popup__header-button">
                    <div className="btn-circle__icon">
            ...
            <div className="popup__content">
              <div className="popup__img">
                <img
                  src="https://dummyimage.com/550x200/#ccc/fff"
                  alt="Register_img"
                  className=""
                ></img>
              </div>
              ...
              <form className="popup__section">
                <div className="form__field">
                  <input
                    type="text"
                    className="form__input"
                    placeholder="Escribe tu mail para participar"
                  ></input>
                </div>
                ...
                <button className="btn-with-icon button-with-icon--offer">
                  ...
                  <div className="btn-with-icon__text">ENTRAR</div>
                </button>
              </form>
        ...
        <h3 className="repository__title">component/popup-map</h3>
          ...
          <div className="popup">
            <div className="popup__header">
              <header className="popup__header-content">
                ...
                <div className="popup__header-center">
                  <h1 className="popup__header-title">Button location</h1>
                </div>
                <div className="popup__header-right">
                  <button className="popup__header-button">
                    <div className="btn-circle__icon">
        ...
        <h3 className="repository__title">component/dropdown-nets</h3>
        ...
        <h3 className="repository__title">component/card-alert</h3>
        ...
        <section className="repository__section">
          <div className="card-alert">
            ...
            <div className="">
              ...
              <h4 className="card-alert__title">Titulo error</h4>
              <p className="card-alert__subtitle">Error mensaje</p>
            </div>
          </div>
        </section>
        ...
        <h3 className="repository__title">component/form-feed</h3>
        ...
        <h3 className="repository__title">component/header-info-overlay</h3>
        ...
        <h3 className="repository__title">component/header-search</h3>
        ...
        <h3 className="repository__title">component/marker-button</h3>

        <section className="repository__section">
          <figure
            id="markerButton"
            className="marker-button marker-button--need"
          >
            ...
            <div className="marker-button__tags marker-button__tags--need">
              <div className="marker-button__link-tag">tag</div>
            </div>
          </figure>
        </section>
        ...
        <section className="repository__section">
          <figure
            id="markerButton"
            className="marker-button marker-button--need marker-button--name-alone"
          >
            <span className="marker-button__arrow"></span>
            <div className="marker-button__tags--need">
              <div className="marker-button__link-tag--alone">palabras</div>
            </div>
          </figure>
        </section>
        ...
        <h3 className="repository__title">component/marker-net</h3>
        ...
        <section className="repository__section">
          <figure id="markerNet" className="marker-net">
            ...
            <div className="marker-net__name">
              <div className="marker-net__link-name">netname</div>
            </div>
          </figure>
        </section>
        ...
        <section className="repository__section">
          <figure
            id="markerButton"
            className="marker-net marker-net--need marker-net--name-alone"
          >
            <span className="marker-net__arrow"></span>
            <div className="marker-net__name">
              <div className="marker-net__link-name--alone">netname</div>
            </div>
          </figure>
        </section>
        ...
        <h3 className="repository__title">component/message</h3>

        <section className="repository__section">
          <div className="message message--me">
            <div className="message__content">message</div>
            <div className="message__hour">00:00</div>
          </div>
        ...
        <h3 className="repository__title">component/nav-bottom</h3>
        ...
        <section className="repository__section">
          <div id="bottom-nav" className="nav-bottom--repo">
            <a href="" className="nav-bottom__link nav-bottom__link--active">
              ...
              <div className="nav-bottom__text">Map</div>
            </a>
            ...
            <a href="" className="nav-bottom__link nav-bottom__link--active">
              ...
              <div className="nav-bottom__text">Create</div>
            </a>
            ...
            <a href="" className="nav-bottom__link nav-bottom__link--active">
              ...
              <div className="nav-bottom__text">Login</div>
            </a>
            ...
            <a href="" className="nav-bottom__link nav-bottom__link--active">
              ...
              <div className="nav-bottom__text">Faqs</div>
            </a>
          </div>
        </section>
        ...
        <h3 className="repository__title">component/nav-header</h3>
        ...
        <section className="repository__section">
          <form className="nav-header__content">
            ...
            <div className="nav-header__content-message">
              <input
                className="form__input nav-header__content-input"
        ...
        <h3 className="repository__title">component/filters</h3>
            ...
            <div className="checkbox-filter__container">
              <label className="checkbox__filter-label">
                ...
                <div className="checkbox-filter__content btn-filter-with-icon">
                  ...
                  <div className="checkbox__text">Necesitan</div>
                </div>
              </label>
            </div>
        ...
        <h3 className="repository__title">component/overlay-loading</h3>
        ...
        <h3 className="repository__title">component/picker</h3>

        <section className="repository__section">
          <div className="picker">
            <div className="picker-box-shadow picker__content picker__options-v ">
              <button
                className="picker__option-btn--active"
                type="button"
                name="button"
              >
                ...
                <div className="picker__option-btn--txt">Ahora</div>
              </button>
              <button
                className="picker__option-btn--active"
                type="button"
              ...
              <button
                className="picker__option-btn-with-icon"
                type="button"
                name="button"
              >
                <div className="picker__option-btn--icon">
        ...
        <h3 className="repository__title">component/accordion</h3>

        <section className="repository__section">
          <button className="accordion">Section 1</button>
          <div className="panel">
            <p>
              Lorem ipsum... palabra. Ejemplo palabras Ejemplo palabras Ejemplo
              palabras Ejemplo palabras Ejemplo palabras Ejemplo palabras.
              Ejemplo palabras Ejemplo palabras Ejemplo palabras ., Ejemplo
              palabrasEjemplo palabras
            </p>
          </div>
