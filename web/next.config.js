...
module.exports = {
    ...
    publicRuntimeConfig: {
        apiUrl: '/api/',
        buttonTypes: process.env.BUTTON_TYPES ? process.env.BUTTON_TYPES : '[{"name":"offer","caption":"Offer","color":"custom","cssColor":"#FFDD02"},{"name":"need","caption":"Need","color":"custom","cssColor":"#19AF96"}]',
    },
    typescript:{
