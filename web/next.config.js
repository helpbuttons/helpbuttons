...
module.exports = {
    ...
    rewrites: async () => {
        return [
          ...
          {
            source: '/api/:path*',
            destination: `${process.env.API_INTERNAL_URL ? process.env.API_INTERNAL_URL : 'http://api:3001/' }:path*`
          },
          {
      ...
      return [
        {
          ...
          destination: (process.env.API_INTERNAL_URL ? process.env.API_INTERNAL_URL : 'http://api:3001/') + 'doc/',
          permanent: true,
        },
        {
          source: '/',
