...
export default function ButtonForm({
  ...
  const generateTitleFromDescription = (description: string) => {
    ...
    const title = words.slice(0, 5).join(' '); // Take the first 5 words of the description
  ...
  useEffect(() => {
    const generatedTitle = generateTitleFromDescription(description);
  ...
  return (
    <LoadabledComponent loading={!selectedNetwork}>
      {selectedNetwork &&
        <Popup title={header} linkFwd={'/Explore'}>
          <Form
              ...
              <>
                <div className="form__inputs-wrapper">
                  ...
                  <FieldTextArea
                    ...
                    name="description"
                    functionExtra={handleDescriptionChange}
                  ...
                  <Accordion extraClass={"accordion--toggle--grey-bordered"} title={t("button.extraOptions")} icon={<IoAdd/>}>
                    <FieldText
                      ...
                      setValue={setValue}
                      defaultValue={title}
                      explain={t('button.titleExplain') + ' ' + t('button.autoGenerated')} // Add translation for auto-generated
                      setFocus={setFocus}
